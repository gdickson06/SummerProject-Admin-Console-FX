...
public class MainMenuController {
	...
	@FXML
	void userUploadCSVButton(ActionEvent event) throws Exception {
		GeneralMethods.ChangeScene("UploadCSVUser");
	}

	@FXML
	void AmendDeleteUser(ActionEvent event) {
		try {
			GeneralMethods.ChangeScene("UserAmendDelete");
		} catch (Exception e) {
	...
	void UploadSingleUser(ActionEvent event) {
		try {
			GeneralMethods.ChangeScene("UploadSingleUser");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
